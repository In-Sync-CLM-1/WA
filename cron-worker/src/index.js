// WA external scheduler — ONE Cloudflare Worker per task.
const FN_BASE = "https://unmdhcjrplwntqjiciiz.supabase.co/functions/v1";
const RPC_BASE = "https://unmdhcjrplwntqjiciiz.supabase.co/rest/v1/rpc";
